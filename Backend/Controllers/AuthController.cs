...
namespace Library.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Signup>>> GetAllUser()
        {
            var userlist = await _authServices.GetAllUser();
            return Ok(new { message = "Fetched all users successfully...", userlist });
        }
